...
```javascript
shellInterface.SonobiHtb = { //shell interface is the window variable that is accessible through the window object, currently this will always be window.headertag
